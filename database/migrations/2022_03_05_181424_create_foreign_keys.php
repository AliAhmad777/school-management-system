...
class CreateForeignKeys extends Migration {
    ...
    //==============================parents============================
        Schema::table('my__parents', function(Blueprint $table) {
			$table->dropForeign('Nationality_Father_id_foreign');
		});

        Schema::table('my__parents', function(Blueprint $table) {
			$table->dropForeign('Blood_Type_Father_id_foreign');
		});

        Schema::table('my__parents', function(Blueprint $table) {
			$table->dropForeign('Religion_Father_id_foreign');
		});

        Schema::table('my__parents', function(Blueprint $table) {
			$table->dropForeign('Nationality_Mother_id_foreign');
		});

        Schema::table('my__parents', function(Blueprint $table) {
			$table->dropForeign('Blood_Type_Mother_id_foreign');
		});

        Schema::table('my__parents', function(Blueprint $table) {
			$table->dropForeign('Religion_Mother_id_foreign');
		});
