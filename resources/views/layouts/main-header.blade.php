    ...
    <ul class="nav navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown mr-30">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#"><i class="text-secondary ti-reload"></i>{{ trans('navbarhead.Activity') }}</a>
                <a class="dropdown-item" href="#"><i class="text-success ti-email"></i>{{ trans('navbarhead.Messages') }}</a>
                <a class="dropdown-item" href="#"><i class="text-warning ti-user"></i>{{ trans('navbarhead.Profile') }}</a>
                <a class="dropdown-item" href="#"><i class="text-dark ti-layers-alt"></i>{{ trans('navbarhead.Projects') }} <span
                        class="badge badge-info">6</span> </a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#"><i class="text-info ti-settings"></i>{{ trans('navbarhead.Settings') }}</a>
                <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i class="text-danger ti-unlock"></i>{{ __('navbarhead.Logout') }}</a>
